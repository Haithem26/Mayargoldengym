...
import treadmills from "../images/musc/DSC_0695.PNG";
    ...
    <div className="training">
      <Fade in={checked} {...(checked ? { timeout: 2000 } : {})}>
        <div className="training-container">
          ...
          <p>
            Notre espace cardio-training dispose d’un équipement complet, simple
            d’utilisation et régulièrement rénové, pour vous permettre
            d’améliorer votre endurance, votre condition physique, vous faire
            perdre du poids en brûlant les graisses…
          </p>
